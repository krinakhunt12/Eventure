    ...
    <div className="max-w-2xl sm:max-w-3xl md:max-w-5xl lg:max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {popularEvents.map((event) => (
          <div
            key={event.id}
            className="bg-white/30 backdrop-blur-md rounded-2xl border border-white/40 overflow-hidden hover:shadow-lg transition-all duration-500 hover:-translate-y-2 group flex flex-col h-full"
          >
            {/* Event Image */}
            <div className="relative overflow-hidden h-40 sm:h-48">
              ...
              />
              {/* Category Badge */}
              <div className="absolute top-2 right-2 sm:top-3 sm:right-3 bg-white/90 backdrop-blur-sm px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs font-semibold text-primary">
                {event.category}
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 flex flex-col h-full">
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-primary mb-2 sm:mb-3 font-['ClashDisplay'] group-hover:text-primary transition-colors">
                {event.title}
              </h3>
              <p className="text-secondary/90 mb-2 sm:mb-4 font-['Satoshi'] text-xs sm:text-sm md:text-base">{event.description}</p>
              
              {/* Event Meta */}
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-secondary/90 mb-3 sm:mb-5 font-['Satoshi']">
              ...
              <div className="flex space-x-2 mt-auto">
                <button className="flex-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-primary-button text-white text-xs sm:text-sm rounded-lg hover:bg-[#23424A] transition flex items-center justify-center font-['Satoshi']">
                  Register Now
                </button>
                <button className="px-2 sm:px-3 py-1.5 sm:py-2 border border-primary text-primary text-xs sm:text-sm rounded-lg hover:bg-primary-button/10 transition flex items-center justify-center">
      ...
      <div className="text-center mt-8 sm:mt-12">
        <button className="px-4 sm:px-6 py-2 sm:py-3 bg-white/30 backdrop-blur-md border-2 border-primary text-primary rounded-xl hover:bg-primary-button hover:text-white transition flex items-center mx-auto font-['Satoshi'] font-medium text-xs sm:text-sm md:text-base">
      ...
      <div className="mt-10 sm:mt-16 bg-white/40 backdrop-blur-md rounded-2xl border border-white/40 p-4 sm:p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row">
          <div className="md:w-1/3 mb-6 md:mb-0 md:pr-8">
            <div className="bg-white/70 p-4 sm:p-6 rounded-xl border border-white/90 h-full">
              <h3 className="text-base sm:text-lg md:text-xl font-bold text-primary mb-2 sm:mb-4 font-['ClashDisplay']">
                <span className="text-secondary">Why attend</span> these events?
              </h3>
              <ul className="space-y-2 sm:space-y-3 font-['Satoshi'] text-xs sm:text-sm md:text-base">
                {[
                  ...
                  <li key={index} className="flex items-start">
                    <div className="w-2 h-2 rounded-full bg-primary-button mt-2 mr-2 sm:mr-3"></div>
          ...
          <div className="md:w-2/3">
            <h3 className="text-base sm:text-lg md:text-xl font-bold text-secondary mb-2 sm:mb-4 font-['ClashDisplay'] uppercase">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-6">
              {[
                ...
                <div key={index} className="bg-white/70 p-3 sm:p-5 rounded-xl border border-white/90">
                  <svg className="w-6 h-6 text-primary mb-2 sm:mb-3" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                  </svg>
                  <p className="text-secondary/90 mb-2 sm:mb-3 italic font-['Satoshi'] text-xs sm:text-sm md:text-base">"{testimonial.quote}"</p>
                  <div className="text-xs sm:text-sm font-['Satoshi']">
