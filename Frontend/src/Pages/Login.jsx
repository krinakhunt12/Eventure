      ...
      <div className="flex flex-1 items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-md w-full space-y-8 bg-white/30 backdrop-blur-md p-10 rounded-3xl border border-white/40 transform transition-all hover:shadow-xl hover:-translate-y-1">
          <div className="text-center">
            <div className="mx-auto h-16 w-16 bg-primary-button rounded-full flex items-center justify-center mb-4">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-primary mb-1 font-['Satoshi']">
                  Email address
                </label>
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  <label htmlFor="password" className="block text-sm font-medium text-primary font-['Satoshi']">
                    Password
                  </label>
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-primary font-['Satoshi']">
                Remember me
              </label>
            </div>
